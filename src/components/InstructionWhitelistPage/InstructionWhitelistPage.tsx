...
import {
  ...
  DeviceInstruction,
  AppType,
} from "@/data/instructionsWhiteList";
import Link from "next/link";
import styles from "../InstructionPage/InstructionPage.module.css";
...
const InstructionWhitelistContent: React.FC = () => {
  ...
  // Удалены неиспользуемые переменные activeThumb и setActiveThumb
  ...
  const updateUrl = (device: string, app: string, mode: "text" | "video") => {
    ...
    router.push(`/instruction-whitelist?${params.toString()}`);
  };
    ...
    <div className={styles.instructionPage}>
      <div className={styles.container}>
        ...
        >
          ...
          <span className={styles.breadcrumbCurrent}>Обход белых списков</span>
          {currentInstruction && (
            <>
              <span className={styles.breadcrumbSeparator}>/</span>
        ...
        >
          <h1 className={styles.title}>Инструкция по обходу белых списков</h1>
        </motion.div>
                    ...
                    <div className={styles.videoContent}>
                      ...
                      <div className={styles.videoInfo}>
                        <p>
                          ...
                          настройки VPN с обходом белых списков на вашем
                          устройстве с помощью {currentApp.name}.
                        </p>
                      </div>
                    </div>
                  ) : (
                    <div className={styles.textContent}>
                      <div className={styles.deviceHeader}>
                        ...
                        <div>
                          ...
                          <p>
                            Пошаговая инструкция по установке и настройке с
                            обходом белых списков
                          </p>
                        </div>
                      </div>
                ...
                !currentApp && (
                  <div className={styles.noAppSelected}>
                    ...
                    <p>
                      ...
                      приложение для настройки обхода белых списков
                    </p>
                    <button
              ...
              >
                <div className={styles.helpCard}>
                  ...
                  <div className={styles.helpContent}>
                    <h3>Нужна помощь?</h3>
                    <p>
                      Если у вас возникли сложности с настройкой обхода белых
                      списков, наша служба поддержки готова помочь вам 24/7
                    </p>
...
const InstructionWhitelistPage: React.FC = () => {
  return (
    <Suspense fallback={<LoadingSpinner />}>
      <InstructionWhitelistContent />
    </Suspense>
  );
};

export default InstructionWhitelistPage;
